...
A pdf introduces pyramidal representation of images and describes the background required to understand the different analyses conducted through the workshop. Links to video tutorials are available in the pdf to see how each "hands on" session can be done. The images used in these sessions are available at [https://zenodo.org/records/18302140](https://zenodo.org/records/18302140). The scripts and Stardist model are available in the script folder.
